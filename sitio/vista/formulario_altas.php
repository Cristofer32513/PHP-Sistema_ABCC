        ...
        <form method="POST" action="../scripts_php/procesar_altas.php" style="width: 80%; padding-left: 10%;">
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="numeroDeControl" name="caja_num_control" required minlength=9 maxlength=9>
                </div>

                <div class="form-group col-md-6">
                    <label for="inputPassword4">Nombre</label>
                    <input type="text" class="form-control" id="nombre" name="caja_nombre" required minlength=0 maxlength=45>
                </div>
            </div>

            <div class="form-group">
                <label for="inputAddress">Primer Apellido</label>
                <input type="text" class="form-control" id="primerApellido" name="caja_primer_ap" required minlength=0 maxlength=45>
            </div>

            <div class="form-group">
                <label for="inputAddress2">Segundo Apellido</label>
                <input type="text" class="form-control" id="segundoApellido" name="caja_segundo_ap" required minlength="0" maxlength="45">
            </div>

            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="inputCity">Edad</label>
                    <input type="number" class="form-control" id="inputCity" name="caja_edad" required min="18" max="23">
                </div>
